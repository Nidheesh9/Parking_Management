...
import Registered_Vehicles from './components/ADMIN/Registered_Vehicles';
import AdminSignup from './components/ADMIN/AdminSignup';
import UserAction from "./context/UserAction";
import SlotAction from "./context/SlotAction";
import UnparkedCar from './components/UnparkedCar';
              ...
              <GetParkingSlotAction>
                <BookSlotAction>
                  ...
                  <Routes>
                    ...
                    <Route path='/slots/:location' element={<Slots />} />
                    <Route path='/registeredVehicles/:id' element={<Registered_Vehicles />} />
                    <Route path='/unparkedCar' element={<UnparkedCar />} />
                  </Routes>
                </BookSlotAction>
              </GetParkingSlotAction>
            </CarAction>
